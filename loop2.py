...
def main():
    ...
    self_uid = get_selfuid(10)
    subnet10(VALI_KEY, self_uid)
    rootnet(VALI_KEY)
...
if __name__ == "__main__":
    ADDRESS_MAPS, WEIGHTS_MAPS, SS58KEY_MAPS = get_all_querymaps()
    VALI_KEY = get_keypair(key_name="embrace_forest")
